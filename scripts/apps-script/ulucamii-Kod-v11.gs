...
function doGet(e) {
  ...
  return json({ ok: true, servis: "ulucamii-alici", surum: 11, zaman: new Date().toISOString() });
}
...
function panelListeIsle(e) {
  try {
    ...
    return json({
      ok: true, surum: 11, zaman: new Date().toISOString(),
...
function panelBelgeIsle(e) {
  try {
    ...
    return json({
      ok: true, surum: 11, ref: ref, kayit: kayit,
