...
function doGet(e) {
  ...
  return json({ ok: true, servis: "ulucamii-alici", surum: 12, zaman: new Date().toISOString() });
}
...
function panelListeIsle(e) {
  try {
    ...
    return json({
      ok: true, surum: 12, zaman: new Date().toISOString(),
...
function panelBelgeIsle(e) {
  try {
    ...
    return json({
      ok: true, surum: 12, ref: ref, kayit: kayit,
