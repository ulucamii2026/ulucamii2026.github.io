/* v27 — EK-10 sürüm kaydı ve çizili imza aktarım izni. */
/**
 * Marche-en-Famenne Ulu Camii — Ortak Apps Script Alıcı (SÜRÜM 27)
...
function doGet(e) {
  ...
  return json({ ok: true, servis: "ulucamii-alici", surum: SURUM,
    ihtidaPaketHazir: typeof IhtidaPdf !== "undefined" && paketSurumu === "27",
...
function doPost(e) {
  try {
    ...
    if (govde.length > AZAMI_GOVDE_BAYT && ["ihtida", "ihtida-paket-onay"].indexOf(v.tur) === -1) {
    ...
    if (v.tur === "ihtida") {
      if (typeof IhtidaPdf === "undefined" || PropertiesService.getScriptProperties().getProperty("IHTIDA_PAKET_KURULU") !== "27") return json({ ok: false, hata: "ihtida-paket-hazir-degil" });
