/* v24 — YEREL HAZIRLIK: teslim tercihi ve şahit seçimi. Henüz dağıtılmadı. */
/**
...
var BASLIKLAR2_IHTIDA = [
  ...
  "Adres sokak", "Posta kodu", "Şehir", "Ülke", "Kimlik belgesi türü"
];
  ...
  try {
    ...
    try {
      ...
      satirEkle(sayfaV2, [
        ...
        b.adresSokak || "", b.postaKodu || "", b.sehir || "", b.ulke || "", v.belgeTuru || ""
      ]);
      SpreadsheetApp.flush();
    ...
    try {
      epostaGonder({
        ...
        body: [
          ...
          "Şahit seçimi        : " + ihtidaSahitMetni(v, "tr"),
          "Belge teslimi       : " + ihtidaTeslimMetni(v, "tr"),
          "Yüklenen belge      : " + (v.belgeTuru === "pasaport" ? "Pasaport (bilgi sayfası)" : "Kimlik kartı (ön + arka)"),
          "Başvuran imzası     : " + (v.imzaYok ? "YOK — tören günü kalemle imzalanacak" : "Formda çizildi"),
          "Görseller           : " + ihtidaGorselOzeti(v.gorseller, gorselHatalari),
          "",
          "EK-9 İhtida Belgesi'ni yönetim panelinden (ulucamii.be/admin/ → Başvurular) üretebilirsiniz;",
          "vesikalık fotoğraf ve başvuranın imzası panele kendiliğinden gelir. Kimlik belgesinin ön/arka",
          "yüzü resmî dosya içindir. Şahit imzaları tören günü kâğıt üzerinde alınır.",
          "Belge basılıp resmî dosya tamamlandıktan sonra kimlik görüntüleri",
          "?islem=ihtida-gorsel-sil&ref=" + ref + "&anahtar=… ucuyla silinebilir.",
          "",
