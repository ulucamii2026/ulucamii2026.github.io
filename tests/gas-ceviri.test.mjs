...
const source = ['kimlik-sabitler.gs', 'veli-eposta-sablon.gs', 'ulucamii-Kod-v40.gs', 'veli-mail-listesi.gs', 'veli-cuma.gs']
...
test('sağlık ucu v36: ceviriMotoru anahtara göre gemini / translate / kapali', () => {
  assert.equal(JSON.parse(backend().ctx.doGet({}).getContent()).surum, 40);
