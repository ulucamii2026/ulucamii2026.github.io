...
| | |
|---|---|
| Düzenleyen | Belçika Diyanet Vakfı — İmam-ı Azam Eğitim Merkezi |
| Yer | Houthalen (Limburg) — yatılı |
| Kimler için | 12–17 yaş erkek öğrenciler |
| Biçim | Hafta sonu yatılı; üç yıllık program |
| Ücret | 175 € (afişte belirtilen ücret) |
| Kayıt | [imamiazam.org](https://imamiazam.org) — çevrimiçi ön kayıt formu |
| Merkezin irtibatı | +32 498 39 95 02 |

## Nasıl kayıt olunur?

1. [imamiazam.org](https://imamiazam.org) adresini açın; ön kayıt formu doğrudan karşınıza çıkar.
...
Bu duyuru, Belçika Diyanet Vakfı İmam-ı Azam Eğitim Merkezi’nin 6 Ağustos 2026 tarihli duyurusuna ve afişine dayanır. Kayıt şartları ve ücret merkez tarafından belirlenir; güncel bilgi için merkezin irtibat numarasını arayın.
