...
Camimiz, Valon Bölgesi tarafından resmî olarak tanınmış (*communauté locale reconnue*) bir ibadet topluluğudur. Bu tanınmışlık statüsü gereği, derneğimizin (ASBL) yanı sıra, 13 Ekim 2005 tarihli Valon Bölgesi Hükûmeti kararnamesi (AGW) uyarınca kurulan ayrı bir kamu hukuku organı olan **"comité"** de camimizin işleyişinde yer almaktadır.
...
Bu hizmetlerin her biri hakkında ayrıntılı bilgiyi ilgili sayfalarımızda bulabilirsiniz.

## Yönetim Yapısı

Derneğimiz, genel kurul ve genel kurulca seçilen yönetim kurulu eliyle yönetilir. Yönetim kurulunda başkan, başkan yardımcısı, sekreter, veznedar ve üyeler görev alır; ayrıca ayrı bir denetim kurulu da bulunmaktadır. Dernek yönetimimiz, camimizin idari ve malî işleyişini şeffaflık ve süreklilik ilkesiyle yürütür.

Son genel kurulumuz **9 Ocak 2026**'da toplanmış ve yönetim kurulumuz bu tarihte yenilenmiştir.
