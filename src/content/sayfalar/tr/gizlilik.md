...
- **Toplanan veriler:** öğrencinin adı, soyadı, cinsiyeti, doğum tarihi, okulu ve sınıfı; velinin yakınlığı, adı soyadı, telefonu, e-postası, adresi ve bilgilendirme dili tercihi (Türkçe/Fransızca); öğrencinin kurs durumu (ilk kez kayıt mı, geçen yıldan devam mı); isteğe bağlı ikinci ulaşılacak kişi; varsa kurs sırasında bilinmesi gereken sağlık notu (yalnız açık rızanızla); görüntü (fotoğraf/video) paylaşım izni tercihiniz — web sitesi/duyurular ve sosyal medya için ayrı ayrı sorulur; kurs kurallarını onayladığınıza dair elektronik beyan (yazdığınız ad soyad ve tarih-saat) ve **ekranda çizdiğiniz imzanız** (13 Eylül 2026 akşamından itibaren): çizdiğiniz imza, kayıt belgesinin (PDF) imza alanına aynen basılır ve kayıt dosyasında aynı belgeyle birlikte saklanır; ekranda imza atamayan için formda bir kaçış kutusu vardır — belgede imza alanına yazdığınız ad basılır, belge ilk derste kalemle imzalanır.
- **Kimlik belgesi kopyası (13 Eylül 2026’dan itibaren, yalnız açık rızanızla):** öğrencinin kimlik belgesinin (Kids-ID, kimlik kartı, pasaport ya da oturma kartı) **ön yüzünün** fotoğrafı; arka yüz isteğe bağlıdır ve istenmez (Belçika kartlarında millî sicil numarası arka yüzdedir). Amaç, kayıt dosyasını tamamlamak ve öğrencinin adının ve doğum tarihinin resmî belgeyle uyuştuğunu doğrulamaktır. Formda bunun için **ayrı bir açık rıza kutusu** vardır ve veli yolu kendisi seçer: fotoğrafı formda yüklemek (varsayılan), onay e-postasını fotoğrafla yanıtlamak, din görevlisine WhatsApp’tan göndermek ya da belgeyi ilk derste elden göstermek (bu durumda kopya alınmaz ve rıza istenmez). Belgedeki numaralar (millî sicil, kimlik veya pasaport numarası) ayrıca kaydedilmez ve otomatik okunmaz (MRZ/OCR yok). Kopya, kayıt belgesine (PDF) basılmaz, hiçbir e-postaya eklenmez, üçüncü kişilerle paylaşılmaz; yalnız kurs idaresinin dernek hesabındaki herkese kapalı Drive klasöründe, kayıt referansıyla adlandırılmış olarak durur ve yönetim panelinden yalnız görüntülenir, indirilmez. WhatsApp yolunu seçerseniz fotoğraf WhatsApp (Meta Platforms Ireland) üzerinden din görevlisinin telefonuna ulaşır; din görevlisi kopyayı kayıt dosyasına aktarır ve telefonundan siler. Rızanızı info@ulucamii.be adresine yazarak her zaman geri alabilirsiniz; kopya o zaman silinir.
- **Toplanmayan veriler:** Belçika millî sicil numarası (rijksregisternummer), T.C. kimlik numarası, kimlik veya pasaport numarası, MRZ taraması, öğrencinin vesikalık fotoğrafı. Belçika hukukunda millî sicil numarası yalnız İçişleri Bakanlığı’nın izin verdiği kurumlarca kullanılabilir (8 Ağustos 1983 tarihli Kanun, md. 8); kimlik kartının kopyası ise kanunun öngördüğü hâller dışında ancak kart sahibinin — çocuk için velisinin — rızasıyla alınabilir (19 Temmuz 1991 tarihli Kanun, md. 6 § 4). Bu nedenle kopya yalnız yukarıdaki açık rızayla ve seçtiğiniz yolla alınır; numaralar hiçbir biçimde kaydedilmez.
