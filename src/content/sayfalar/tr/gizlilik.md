...
- **Toplanan veriler:** öğrencinin adı, soyadı, cinsiyeti, doğum tarihi, okulu ve sınıfı; velinin yakınlığı, adı soyadı, telefonu, e-postası, adresi ve bilgilendirme dili tercihi (Türkçe/Fransızca); öğrencinin kurs durumu (ilk kez kayıt mı, geçen yıldan devam mı); isteğe bağlı ikinci ulaşılacak kişi; varsa kurs sırasında bilinmesi gereken sağlık notu (yalnız açık rızanızla); görüntü (fotoğraf/video) paylaşım izni tercihiniz; kurs kurallarını onayladığınıza dair elektronik beyan (yazdığınız ad soyad ve tarih-saat).
