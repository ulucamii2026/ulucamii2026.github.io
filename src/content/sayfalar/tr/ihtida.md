...
Başvuru ve tören için yanınızda bulundurmanız gerekenler:

- Kimlik kartı veya pasaportunuzun fotokopisi (kimlik kartında ön-arka).
- 1 adet vesikalık fotoğraf.
- Doldurulmuş başvuru formu/dilekçe (aşağıdaki online formu kullanabilirsiniz).
- KVKK açık rıza onayınız (form içinde imzalanır).
- Sizinle birlikte gelecek **2 şahit**.
...
Camimiz, önümüzdeki dönemde yeni Müslüman olan kardeşlerimize yönelik bir tanışma/mentörlük ve düzenli takip imkânı geliştirmeyi **hedeflemektedir**; bu konudaki çalışmalar henüz olgunlaşma aşamasındadır ve mevcut resmî bir hizmet taahhüdü değildir.

## Sıkça Sorulan Sorular

**İsmimi değiştirmek zorunda mıyım?**
Hayır. İsim değişikliği tamamen isteğe bağlıdır; isterseniz size öneri sunulur.

**Ailem veya çevrem bu süreçten haberdar olur mu?**
Hayır. Bilgileriniz gizli tutulur ve yalnızca yetkili asgari sayıda kişiyle (görevli, Müşavirlik) paylaşılır.
...
**Ne kadar sürer?**
Tören ve yerel belge takdimi genellikle aynı gün tamamlanır; resmî arşiv kaydı birkaç hafta sürebilir.

## Randevu / İletişim

Sorularınız için din görevlimizle doğrudan iletişime geçebilir veya aşağıdaki online formu doldurarak başvurunuzu iletebilirsiniz.
