...
- **Storage and processor:** the registration row and the automatically generated registration document (PDF) are stored on Google infrastructure (Google Ireland Ltd.) — Google Apps Script, Drive and Sheets — in the association’s account; a PDF copy is e-mailed to the parent through the e-mail delivery service **Brevo (Sendinblue SAS, France; data processed within the European Union)**, from the address `info@ulucamii.be`. Only the course administration and the imam have access; nothing is shared with third parties.
- **Retention period:** registration period + 2 years. The health note is kept only in the registration register (it is not included in the registration document stored on Drive) and is deleted from it at the end of the school year concerned; the copy e-mailed to you stays with you.
