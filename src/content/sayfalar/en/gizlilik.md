...
- **Storage and processor:** the registration row and the automatically generated registration document (PDF) are stored on Google infrastructure (Google Ireland Ltd.) — Google Apps Script, Drive and Sheets — in the association’s account; a PDF copy is e-mailed to the parent through the e-mail delivery service **Brevo (Sendinblue SAS, France; data processed within the European Union)**, from the address `info@ulucamii.be`. The copy of the identity document is kept in the same association account, in a separate closed folder. Only the course administration and the imam have access; nothing is shared with third parties.
