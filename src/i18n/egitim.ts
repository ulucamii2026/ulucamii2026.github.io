...
export const EGITIM: Record<Dil, EgitimMetni> = {
  tr: {
    baslik: 'Yeni Müslümanlar için eğitim',
    ...
    dilNotu: 'Sesli derslerin açıklamaları ve başlıkları Fransızca, tilavetler Arapçadır. Aşağıdaki bütün dersleri doğrudan açabilirsiniz.',
  ...
  fr: {
    baslik: 'Formation pour les nouveaux musulmans',
    ...
    dilNotu: 'Les titres et les explications des cours audio sont en français, les récitations en arabe. Tous les cours ci-dessous sont accessibles directement.',
  ...
  en: {
    baslik: 'Learning for new Muslims',
    ...
    dilNotu: 'Audio lesson titles and explanations are in French; recitations are in Arabic. You can open every lesson below directly.',
  ...
  nl: {
    baslik: 'Onderwijs voor nieuwe moslims',
    ...
    dilNotu: 'De titels en uitleg van de audiolessen zijn in het Frans; de recitaties zijn in het Arabisch. U kunt alle lessen hieronder rechtstreeks openen.',
  ...
  de: {
    baslik: 'Unterricht für neue Muslime',
    ...
    dilNotu: 'Die Titel und Erklärungen der Audiokurse sind auf Französisch, die Rezitationen auf Arabisch. Alle folgenden Kurse sind direkt zugänglich.',
