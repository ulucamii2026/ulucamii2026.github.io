 ...
 * Arapça metin, okunuş, TR/FR/EN/NL/DE anlamlar ve doğrulanmış ses bağlantıları.
 */
...
export const EZBER_LISTESI: EzberOgesi[] = [
  ...
  {
    id: 'ayetel-kursi',
    ad: { tr: 'Âyetü’l-Kürsî', fr: 'Ayat Al-Kursi (Verset du Trône)', en: 'Ayat Al-Kursi (Throne Verse)', nl: 'Ayat Al-Koersie (het Troonvers)', de: 'Ayat Al-Kursi (Thronvers)' },
    tur: 'sure',
  ...
  {
    id: 'insirah',
    ad: { tr: 'İnşirâh Sûresi', fr: 'Sourate Al-Inshirah', en: 'Surah Al-Inshirah', nl: 'Soera Al-Insjirah', de: 'Sure Al-Inschirah' },
    tur: 'sure',
  ...
  {
    id: 'kadir',
    ad: { tr: 'Kadir Sûresi', fr: 'Sourate Al-Qadr', en: 'Surah Al-Qadr', nl: 'Soera Al-Qadr', de: 'Sure Al-Qadr' },
    tur: 'sure',
  ...
  {
    id: 'asr',
    ad: { tr: 'Asr Sûresi', fr: 'Sourate Al-Asr', en: 'Surah Al-Asr', nl: 'Soera Al-Asr', de: 'Sure Al-Asr' },
    tur: 'sure',
  ...
  {
    id: 'fil',
    ad: { tr: 'Fîl Sûresi', fr: 'Sourate Al-Fil', en: 'Surah Al-Feel', nl: 'Soera Al-Fiel', de: 'Sure Al-Fil' },
    tur: 'sure',
  ...
  {
    id: 'kureys',
    ad: { tr: 'Kureyş Sûresi', fr: 'Sourate Quraïsh', en: 'Surah Quraysh', nl: 'Soera Qoeraisj', de: 'Sure Quraisch' },
    tur: 'sure',
  ...
  {
    id: 'maun',
    ad: { tr: 'Mâûn Sûresi', fr: 'Sourate Al-Ma’un', en: 'Surah Al-Maoon', nl: 'Soera Al-Ma’oen', de: 'Sure Al-Ma’un' },
    tur: 'sure',
  ...
  {
    id: 'kevser',
    ad: { tr: 'Kevser Sûresi', fr: 'Sourate Al-Kawthar', en: 'Surah Al-Kawthar', nl: 'Soera Al-Kawthar', de: 'Sure Al-Kauthar' },
    tur: 'sure',
  ...
  {
    id: 'kafirun',
    ad: { tr: 'Kâfirûn Sûresi', fr: 'Sourate Al-Kafirun', en: 'Surah Al-Kafiroon', nl: 'Soera Al-Kafiroen', de: 'Sure Al-Kafirun' },
    tur: 'sure',
  ...
  {
    id: 'nasr',
    ad: { tr: 'Nasr Sûresi', fr: 'Sourate An-Nasr', en: 'Surah An-Nasr', nl: 'Soera An-Nasr', de: 'Sure An-Nasr' },
    tur: 'sure',
  ...
  {
    id: 'tebbet',
    ad: { tr: 'Tebbet Sûresi', fr: 'Sourate Al-Massad (Tabbat)', en: 'Surah Al-Masad', nl: 'Soera Al-Masad (Tabbat)', de: 'Sure Al-Masad (Tabbat)' },
    tur: 'sure',
  ...
  {
    id: 'ihlas',
    ad: { tr: 'İhlâs Sûresi', fr: 'Sourate Al-Ikhlas', en: 'Surah Al-Ikhlas', nl: 'Soera Al-Ichlaas', de: 'Sure Al-Ichlas' },
    tur: 'sure',
  ...
  {
    id: 'felak',
    ad: { tr: 'Felak Sûresi', fr: 'Sourate Al-Falaq', en: 'Surah Al-Falaq', nl: 'Soera Al-Falaq', de: 'Sure Al-Falaq' },
    tur: 'sure',
  ...
  {
    id: 'nas',
    ad: { tr: 'Nâs Sûresi', fr: 'Sourate An-Nas', en: 'Surah An-Nas', nl: 'Soera An-Naas', de: 'Sure An-Nas' },
    tur: 'sure',
  ...
  {
    id: 'subhaneke',
    ad: { tr: 'Sübhâneke Duası', fr: 'Invocation Subhânaka', en: 'Subhanaka Prayer', nl: 'Gebed Soebhanaka', de: 'Bittgebet Subhanaka' },
    tur: 'dua',
    ...
    anlam: {
      ...
      nl: 'O Allah! U bent vrij van elk gebrek, en ik prijs U met Uw lof. Uw naam is gezegend, Uw majesteit is verheven, en er is geen god buiten U.',
      de: 'O Allah! Du bist frei von jedem Mangel, und ich lobe Dich mit Deinem Lob. Dein Name ist gesegnet, Deine Erhabenheit ist hoch, und es gibt keinen Gott außer Dir.',
    },
    sesUrl: '/media/ses/dualar/subhaneke.mp3',
  },
  {
    id: 'tahiyyat',
    ad: { tr: 'Ettehiyyâtü (Tahiyyât)', fr: 'Invocation At-Tahiyyat', en: 'At-Tahiyyat Prayer', nl: 'Gebed At-Tahiyyaat', de: 'Bittgebet At-Tahiyyat' },
    tur: 'dua',
    ...
    anlam: {
      ...
      nl: 'Alle gebeden, alle lofprijzingen, alle vormen van aanbidding en alle goede daden komen Allah toe. Vrede zij met u, o Profeet, en de barmhartigheid van Allah en Zijn zegeningen. Vrede zij met ons en met de oprechte dienaren van Allah. Ik getuig dat er geen god is dan Allah, en ik getuig dat Mohammed Zijn dienaar en Zijn gezant is.',
      de: 'Alle Gebete, alle Lobpreisungen, alle Gottesdienste und alle guten Werke gebühren Allah. Friede sei mit dir, o Prophet, und die Barmherzigkeit Allahs und Seine Segnungen. Friede sei mit uns und mit den rechtschaffenen Dienern Allahs. Ich bezeuge, dass es keinen Gott gibt außer Allah, und ich bezeuge, dass Muhammad Sein Diener und Sein Gesandter ist.',
    },
    sesUrl: '/media/ses/dualar/tahiyyat.mp3',
  },
  {
    id: 'salli-barik',
    ad: { tr: 'Allâhümme Salli & Bârik', fr: 'Salutations sur le Prophète (Salli & Barik)', en: 'Allahumma Salli & Barik', nl: 'Zegenbede voor de Profeet (Salli & Barik)', de: 'Segensgebet für den Propheten (Salli & Barik)' },
    tur: 'dua',
    ...
    anlam: {
      ...
      nl: 'O Allah! Schenk Uw genade aan Mohammed en aan de familie van Mohammed, zoals U Uw genade hebt geschonken aan Ibrahim en aan de familie van Ibrahim. Voorwaar, U bent de Geprezene, de Glorierijke. O Allah! Schenk Uw zegen aan Mohammed en aan de familie van Mohammed, zoals U Uw zegen hebt geschonken aan Ibrahim en aan de familie van Ibrahim. Voorwaar, U bent de Geprezene, de Glorierijke.',
      de: 'O Allah! Erweise Muhammad und der Familie Muhammads Deine Gnade, so wie Du Ibrahim und der Familie Ibrahims Deine Gnade erwiesen hast. Wahrlich, Du bist der Gepriesene, der Ruhmreiche. O Allah! Segne Muhammad und die Familie Muhammads, so wie Du Ibrahim und die Familie Ibrahims gesegnet hast. Wahrlich, Du bist der Gepriesene, der Ruhmreiche.',
    },
    sesUrl: '/media/ses/dualar/sallibarik.mp3',
  },
  {
    id: 'rabbena',
    ad: { tr: 'Rabbenâ Âtinâ & Rabbenâğfirlî', fr: 'Invocations Rabbana', en: 'Rabbana Duas', nl: 'Rabbana-gebeden', de: 'Rabbana-Bittgebete' },
    tur: 'dua',
    ...
    anlam: {
      ...
      nl: 'Onze Heer! Geef ons het goede in deze wereld en het goede in het hiernamaals, en bescherm ons tegen de bestraffing van het Vuur. Onze Heer! Vergeef mij, mijn ouders en alle gelovigen op de Dag waarop de afrekening plaatsvindt.',
      de: 'Unser Herr! Gib uns Gutes in dieser Welt und Gutes im Jenseits und bewahre uns vor der Strafe des Feuers. Unser Herr! Vergib mir, meinen Eltern und allen Gläubigen an dem Tag, an dem die Abrechnung stattfindet.',
    },
