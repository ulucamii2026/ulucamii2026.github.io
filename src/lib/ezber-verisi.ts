...
export const EZBER_LISTESI: EzberOgesi[] = [
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ أَلَمْ نَشْرَحْ لَكَ صَدْرَكَ ﴿١﴾ وَوَضَعْنَا عَنكَ وِزْرَكَ ﴿٢﴾ الَّذِي أَنقَضَ ظَهْرَكَ ﴿٣﴾ وَرَفَعْنَا لَكَ ذِكْرَكَ ﴿٤﴾ فَإِنَّ مَعَ الْعُسْرِ يُسْرًا ﴿٥﴾ إِنَّ مَعَ الْعُسْرِ يُسْرًا ﴿٦﴾ فَإِذَا فَرَغْتَ فَانصَبْ ﴿٧﴾ وَإِلَىٰ رَبِّكَ فَارْغَب ﴿٨﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. Senin göğsünü açıp genişletmedik mi? Belini büken yükünü üzerinden atmadık mı? Senin şanını ve namını yüceltmedik mi? Elbette zorlukla beraber bir kolaylık vardır. Gerçekten zorlukla beraber bir kolaylık vardır. Öyleyse bir işi bitirince diğerine koyul ve yalnız Rabbine yönel.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. N’avons-Nous pas ouvert pour toi ta poitrine ? Et ne t’avons-Nous pas déchargé de ton fardeau qui accablait ton dos ? Et exalté pour toi ta renommée ? À côté de la difficulté est certes une facilité ! Oui, à côté de la difficulté est une facilité. Quand tu as terminé, lève-toi donc, et vers ton Seigneur chemine avec ardeur.',
      en: 'In the name of Allah, the Entirely Merciful, the Especially Merciful. Did We not expand for you, [O Muhammad], your breast? And We removed from you your burden which had weighed upon your back, and raised high for you your repute. For indeed, with hardship [will be] ease. Indeed, with hardship [will be] ease. So when you have finished [your duties], then stand up [for worship]. And to your Lord direct [your] longing.',
    },
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ إِنَّا أَنزَلْنَاهُ فِي لَيْلَةِ الْقَدْرِ ﴿١﴾ وَمَا أَدْرَاكَ مَا لَيْلَةُ الْقَدْرِ ﴿٢﴾ لَيْلَةُ الْقَدْرِ خَيْرٌ مِّنْ أَلْفِ شَهْرٍ ﴿٣﴾ تَنَزَّلُ الْمَلَائِكَةُ وَالرُّوحُ فِيهَا بِإِذْنِ رَبِّهِم مِّن كُلِّ أَمْرٍ ﴿٤﴾ سَلَامٌ هِيَ حَتَّىٰ مَطْلَعِ الْفَجْرِ ﴿٥﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. Şüphesiz biz onu (Kur’an’ı) Kadir gecesinde indirdik. Kadir gecesinin ne olduğunu sen ne bileceksin? Kadir gecesi bin aydan daha hayırlıdır. Melekler ve Ruh (Cebrail), o gecede Rablerinin izniyle her türlü iş için iner dururlar. O gece, tanyeri ağarıncaya kadar esenliktir.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. Nous l’avons certes fait descendre pendant la nuit d’Al-Qadr. Et qui te dira ce qu’est la nuit d’Al-Qadr ? La nuit d’Al-Qadr est meilleure que mille mois. Durant celle-ci descendent les Anges ainsi que l’Esprit, par permission de leur Seigneur pour tout ordre. Elle est paix et salut jusqu’à l’apparition de l’aube.',
      en: 'In the name of Allah, the Entirely Merciful, the Especially Merciful. Indeed, We sent the Quran down during the Night of Decree. And what can make you know what is the Night of Decree? The Night of Decree is better than a thousand months. The angels and the Spirit descend therein by permission of their Lord for every matter. Peace it is until the emergence of dawn.',
    },
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ وَالْعَصْرِ ﴿١﴾ إِنَّ الْإِنسَانَ لَفِي خُسْرٍ ﴿٢﴾ إِلَّا الَّذِينَ آمَنُوا وَعَمِلُوا الصَّالِحَاتِ وَتَوَاصَوْا بِالْحَقِّ وَتَوَاصَوْا بِالصَّبْرِ ﴿٣﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. Asra yemin olsun ki, insan gerçekten ziyan içindedir. Ancak iman edip salih ameller işleyenler, birbirlerine hakkı ve sabrı tavsiye edenler müstesnadır.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. Par le Temps ! L’homme est certes en perdition, sauf ceux qui croient et accomplissent les bonnes œuvres, s’enjoignent mutuellement la vérité et s’enjoignent mutuellement l’endurance.',
      en: 'In the name of Allah, the Entirely Merciful, the Especially Merciful. By time, indeed, mankind is in loss, except for those who have believed and done righteous deeds and advised each other to truth and advised each other to patience.',
    },
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ أَلَمْ تَرَ كَيْفَ فَعَلَ رَبُّكَ بِأَصْحَابِ الْفِيلِ ﴿١﴾ أَلَمْ يَجْعَلْ كَيْدَهُمْ فِي تَضْلِيلٍ ﴿٢﴾ وَأَرْسَلَ عَلَيْهِمْ طَيْرًا أَبَابِيلَ ﴿٣﴾ تَرْمِيهِم بِحِجَارَةٍ مِّن سِجِّيلٍ ﴿٤﴾ فَجَعَلَهُمْ كَعَصْفٍ مَّأْكُولٍ ﴿٥﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. Rabbinin fil sahiplerine neler ettiğini görmedin mi? Onların kötü planlarını boşa çıkarmadı mı? Onların üzerine sürü sürü kuşlar gönderdi; onlara çamurdan pişirilmiş sert taşlar atan. Sonunda onları yenilmiş ekin yaprağı gibi kıldı.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. N’as-tu pas vu comment ton Seigneur a agi envers les gens de l’Éléphant ? N’a-t-Il pas rendu leur ruse complètement vaine ? Et envoyé sur eux des oiseaux par volées qui leur lançaient des pierres d’argile, et Il les a rendus semblables à une paille mâchée.',
      en: 'In the name of Allah, the Entirely Merciful, the Especially Merciful. Have you not considered how your Lord dealt with the companions of the elephant? Did He not make their plan into misguidance? And He sent against them birds in flocks, striking them with stones of hard clay, and He made them like eaten straw.',
    },
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ لِإِيلَافِ قُرَيْشٍ ﴿١﴾ إِيلَافِهِمْ رِحْلَةَ الشِّتَاءِ وَالصَّيْفِ ﴿٢﴾ فَلْيَعْبُدُوا رَبَّ هَٰذَا الْبَيْتِ ﴿٣﴾ الَّذِي أَطْعَمَهُم مِّن جُوعٍ وَآمَنَهُم مِّنْ خَوْفٍ ﴿٤﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. Kureyş’in güven ve uzlaşmasını sağladığı için; kış ve yaz yolculuklarında onları uzlaştırdığı için, onlar da bu Ev’in (Kâbe’nin) Rabbine kulluk etsinler; ki O, kendilerini açlıktan kurtarıp doyurdu ve her türlü korkudan emin kıldı.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. À cause du pacte des Quraysh, de leur pacte lors du voyage d’hiver et d’été ! Qu’ils adorent donc le Seigneur de cette Maison (la Kaaba), qui les a nourris contre la faim et rassurés de la peur !',
      en: 'In the name of Allah, the Entirely Merciful, the Especially Merciful. For the accustomed security of the Quraysh—their accustomed security in the caravan of winter and summer—let them worship the Lord of this House, who has fed them against hunger and made them safe from fear.',
    },
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ أَرَأَيْتَ الَّذِي يُكَذِّبُ بِالدِّينِ ﴿١﴾ فَذَٰلِكَ الَّذِي يَدُعُّ الْيَتِيمَ ﴿٢﴾ وَلَا يَحُضُّ عَلَىٰ طَعَامِ الْمِسْكِينِ ﴿٣﴾ فَوَيْلٌ لِّلْمُصَلِّينَ ﴿٤﴾ الَّذِينَ هُمْ عَن صَلَاتِهِمْ سَاهُونَ ﴿٥﴾ الَّذِينَ هُمْ يُرَاءُونَ ﴿٦﴾ وَيَمْنَعُونَ الْمَاعُونَ ﴿٧﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. Dini (hesap gününü) yalanlayanı gördün mü? İşte o, yetimi itip kakar, yoksulu doyurmayı teşvik etmez. Yazıklar olsun o namaz kılanlara ki, onlar namazlarını ciddiye almazlar; onlar gösteriş yaparlar ve en ufak bir yardıma bile engel olurlar.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. Vois-tu celui qui traite de mensonge la Rétribution ? C’est bien lui qui repousse l’orphelin, et qui n’encourage point à nourrir le pauvre. Malheur donc aux prieurs qui sont négligents dans leur prière, qui font preuve d’ostentation et refusent la moindre aide usuelle !',
      en: 'In the name of Allah, the Entirely Merciful, the Especially Merciful. Have you seen the one who denies the Recompense? For that is the one who drives away the orphan and does not encourage the feeding of the poor. So woe to those who pray [but] who are heedless of their prayer—those who make a show of their deeds and withhold simple assistance.',
    },
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ قُلْ يَا أَيُّهَا الْكَافِرُونَ ﴿١﴾ لَا أَعْبُدُ مَا تَعْبُدُونَ ﴿٢﴾ وَلَا أَنتُمْ عَابِدُونَ مَا أَعْبُدُ ﴿٣﴾ وَلَا أَنَا عَابِدٌ مَّا عَبَدتُّمْ ﴿٤﴾ وَلَا أَنتُمْ عَابِدُونَ مَا أَعْبُدُ ﴿٥﴾ لَكُمْ دِينُكُمْ وَلِيَ دِينِ ﴿٦﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. De ki: Ey inkârcılar! Ben sizin taptıklarınıza tapmam. Siz de benim taptığıma tapacak değilsiniz. Ben de sizin taptıklarınıza tapacak değilim. Siz de benim taptığıma tapacak değilsiniz. Sizin dininiz size, benim dinim banadır.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. Dis : « Ô vous les infidèles ! Je n’adore pas ce que vous adorez. Et vous n’êtes pas adorateurs de ce que j’adore. Je ne suis pas adorateur de ce que vous adorez. Et vous n’êtes pas adorateurs de ce que j’adore. À vous votre religion, et à moi ma religion. »',
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ إِذَا جَاءَ نَصْرُ اللَّهِ وَالْفَتْحُ ﴿١﴾ وَرَأَيْتَ النَّاسَ يَدْخُلُونَ فِي دِينِ اللَّهِ أَفْوَاجًا ﴿٢﴾ فَسَبِّحْ بِحَمْدِ رَبِّكَ وَاسْتَغْفِرْهُ ۚ إِنَّهُ كَانَ تَوَّابًا ﴿٣﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. Allah’ın yardımı ve zafer geldiği, insanların da dalga dalga Allah’ın dinine girdiklerini gördüğün zaman, hemen Rabbini överek tesbih et ve O’ndan bağışlanma dile. Şüphesiz O, tevbeleri çokça kabul edendir.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. Lorsque vient le secours d’Allah ainsi que la victoire, et que tu vois les gens entrer en foule dans la religion d’Allah, alors par la louange célèbre la gloire de ton Seigneur et implore Son pardon. Certes, Il est Grand Accueillant au repentir.',
  ...
  },
  {
    ...
    tur: 'sure',
    arapca: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ﴿١﴾ تَبَّتْ يَدَا أَبِي لَهَبٍ وَتَبَّ ﴿١﴾ مَا أَغْنَىٰ عَنْهُ مَالُهُ وَمَا كَسَبَ ﴿٢﴾ سَيَصْلَىٰ نَارًا ذَاتَ لَهَبٍ ﴿٣﴾ وَامْرَأَتُهُ حَمَّالَةَ الْحَطَبِ ﴿٤﴾ فِي جِيدِهَا حَبْلٌ مِّن مَّسَدٍ ﴿٥﴾',
    ...
    anlam: {
      tr: 'Rahmân ve Rahîm olan Allah’ın adıyla. Ebû Leheb’in iki eli kurusun; kurudu da! Malı da kazandıkları da ona fayda vermedi. O, alevli bir ateşe girecektir. Boynunda bükülmüş bir ip bulunan karısı da, odun taşıyıcı olarak oraya girecektir.',
      fr: 'Au nom d’Allah, le Tout Miséricordieux, le Très Miséricordieux. Que périssent les deux mains d’Abû Lahab et que lui-même périsse ! Sa fortune ne lui a servi à rien, ni ce qu’il a acquis. Il brûlera dans un Feu plein de flammes, de même que sa femme, la porteuse de bois, avec à son cou une corde de fibres.',
