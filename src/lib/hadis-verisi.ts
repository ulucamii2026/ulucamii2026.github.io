 ...
 * Çocuklar için seçilmiş Nebevî tavsiyeler (TR / FR / EN / NL / DE).
 */
...
export const AHLAK_HADISLERI: HadisOgesi[] = [
  {
    ...
    metin: {
      ...
      nl: 'Glimlachen naar uw geloofsbroeder is voor u een aalmoes.',
      de: 'Ihrem Glaubensbruder zuzulächeln ist für Sie ein Almosen.',
    },
  ...
  },
  {
    ...
    metin: {
      ...
      nl: 'De beste onder u is degene die de Koran leert en onderwijst.',
      de: 'Der Beste unter Ihnen ist derjenige, der den Koran lernt und ihn lehrt.',
    },
  ...
  },
  {
    ...
    konu: {
      ...
      nl: 'Reinheid & Zuiverheid',
      de: 'Sauberkeit & Reinheit',
    },
    ikon: '💧',
  },
  {
    ...
    konu: {
      ...
      en: 'Respect & Mercy',
      nl: 'Respect & Barmhartigheid',
      de: 'Respekt & Barmherzigkeit',
    },
    ikon: '🤝',
  },
  {
    ...
    metin: {
      ...
      nl: 'Waarachtigheid leidt tot het goede, en het goede leidt naar het paradijs.',
      de: 'Wahrhaftigkeit führt zum Guten, und das Gute führt ins Paradies.',
    },
    ...
    konu: {
      ...
      fr: 'Vérité & Sincérité',
      en: 'Truth & Honesty',
      nl: 'Waarheid & Eerlijkheid',
      de: 'Wahrheit & Ehrlichkeit',
    },
    ikon: '✨',
  },
  {
    ...
    metin: {
      ...
      nl: 'Geef elkaar geschenken, dan groeit de liefde onder u.',
      de: 'Beschenken Sie einander, so wächst die Liebe unter Ihnen.',
    },
    ...
    konu: {
      ...
      nl: 'Vrijgevigheid & Delen',
      de: 'Großzügigkeit & Teilen',
    },
    ikon: '🎁',
  },
  {
    ...
    metin: {
      ...
      nl: 'Wie de mensen niet dankt, dankt ook Allah niet.',
      de: 'Wer den Menschen nicht dankt, dankt auch Allah nicht.',
    },
    ...
    konu: {
      ...
      en: 'Gratitude & Thanks',
      nl: 'Dankbaarheid & Erkentelijkheid',
      de: 'Dankbarkeit & Dank',
    },
    ikon: '🙏',
  },
  {
    ...
    metin: {
      ...
      nl: 'Een goed woord spreken is een aalmoes.',
      de: 'Ein gutes Wort zu sprechen ist ein Almosen.',
    },
    ...
    konu: {
      ...
      nl: 'Vriendelijke Woorden & Beleefdheid',
      de: 'Freundliche Worte & Höflichkeit',
    },
    ikon: '🌸',
  },
  {
    ...
    metin: {
      ...
      nl: 'Wie verzadigd gaat slapen terwijl zijn buur honger heeft, is geen ware gelovige.',
      de: 'Wer satt schlafen geht, während sein Nachbar hungert, ist kein wahrer Gläubiger.',
    },
    ...
    konu: {
      ...
      nl: 'Hulpvaardigheid & Goed Nabuurschap',
      de: 'Hilfsbereitschaft & Gute Nachbarschaft',
    },
    ikon: '🏡',
  },
  {
    ...
    metin: {
      ...
      nl: 'Maak het gemakkelijk en niet moeilijk; breng goed nieuws en jaag niemand weg.',
      de: 'Machen Sie es leicht und nicht schwer; verkünden Sie frohe Botschaft und stoßen Sie niemanden ab.',
    },
    ...
    konu: {
      ...
      nl: 'Gemak & Goed Nieuws',
      de: 'Erleichterung & Frohe Botschaft',
    },
    ikon: '🕊️',
  },
];
