...
| Kur'an kursu müfredatı / yıllık plan / kitap-sayfa künyesi (24 Eylül 2026 revizyonu) | [Müfredat ve yıllık plan](MUFREDAT-VE-YILLIK-PLAN.md) | `src/data/{yillik-plan-2026-2027.json, mufredat-*, ders-defteri-2026-2027.json, konular-fr.json, konular-en.json, ders-konu-fr.ts}`; üretici `D:/app/marche-cami-sitesi/mufredat/`; `npm run dogrula`, `mufredat-test.py`, GAS `mufredat-yukle` |
